...
const (
	...
	AuthServiceName = "skillsphere.handler.v1.AuthService"
)
...
const (
	...
	AuthServiceRegisterProcedure = "/skillsphere.handler.v1.AuthService/Register"
	// AuthServiceLoginProcedure is the fully-qualified name of the AuthService's Login RPC.
	AuthServiceLoginProcedure = "/skillsphere.handler.v1.AuthService/Login"
	// AuthServiceLogoutProcedure is the fully-qualified name of the AuthService's Logout RPC.
	AuthServiceLogoutProcedure = "/skillsphere.handler.v1.AuthService/Logout"
	// AuthServiceRefreshTokenProcedure is the fully-qualified name of the AuthService's RefreshToken
	// RPC.
	AuthServiceRefreshTokenProcedure = "/skillsphere.handler.v1.AuthService/RefreshToken"
	// AuthServiceValidateTokenProcedure is the fully-qualified name of the AuthService's ValidateToken
	// RPC.
	AuthServiceValidateTokenProcedure = "/skillsphere.handler.v1.AuthService/ValidateToken"
	// AuthServiceOAuthLoginProcedure is the fully-qualified name of the AuthService's OAuthLogin RPC.
	AuthServiceOAuthLoginProcedure = "/skillsphere.handler.v1.AuthService/OAuthLogin"
	// AuthServiceRequestPasswordResetProcedure is the fully-qualified name of the AuthService's
	// RequestPasswordReset RPC.
	AuthServiceRequestPasswordResetProcedure = "/skillsphere.handler.v1.AuthService/RequestPasswordReset"
	// AuthServiceResetPasswordProcedure is the fully-qualified name of the AuthService's ResetPassword
	// RPC.
	AuthServiceResetPasswordProcedure = "/skillsphere.handler.v1.AuthService/ResetPassword"
	// AuthServiceChangePasswordProcedure is the fully-qualified name of the AuthService's
	// ChangePassword RPC.
	AuthServiceChangePasswordProcedure = "/skillsphere.handler.v1.AuthService/ChangePassword"
	// AuthServiceVerifyEmailProcedure is the fully-qualified name of the AuthService's VerifyEmail RPC.
	AuthServiceVerifyEmailProcedure = "/skillsphere.handler.v1.AuthService/VerifyEmail"
	// AuthServiceResendVerificationEmailProcedure is the fully-qualified name of the AuthService's
	// ResendVerificationEmail RPC.
	AuthServiceResendVerificationEmailProcedure = "/skillsphere.handler.v1.AuthService/ResendVerificationEmail"
)
...
// AuthServiceClient is a client for the skillsphere.handler.v1.AuthService service.
...
// NewAuthServiceClient constructs a client for the skillsphere.handler.v1.AuthService service. By
...
// Register calls skillsphere.handler.v1.AuthService.Register.
...
// Login calls skillsphere.handler.v1.AuthService.Login.
func (c *authServiceClient) Login(ctx context.Context, req *connect.Request[v1.LoginRequest]) (*connect.Response[v1.LoginResponse], error) {
	return c.login.CallUnary(ctx, req)
}

// Logout calls skillsphere.handler.v1.AuthService.Logout.
...
// RefreshToken calls skillsphere.handler.v1.AuthService.RefreshToken.
...
// ValidateToken calls skillsphere.handler.v1.AuthService.ValidateToken.
...
// OAuthLogin calls skillsphere.handler.v1.AuthService.OAuthLogin.
...
// RequestPasswordReset calls skillsphere.handler.v1.AuthService.RequestPasswordReset.
...
// ResetPassword calls skillsphere.handler.v1.AuthService.ResetPassword.
...
// ChangePassword calls skillsphere.handler.v1.AuthService.ChangePassword.
...
// VerifyEmail calls skillsphere.handler.v1.AuthService.VerifyEmail.
...
// ResendVerificationEmail calls skillsphere.handler.v1.AuthService.ResendVerificationEmail.
...
// AuthServiceHandler is an implementation of the skillsphere.handler.v1.AuthService service.
...
func NewAuthServiceHandler(svc AuthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/skillsphere.handler.v1.AuthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuthServiceHandler) Register(context.Context, *connect.Request[v1.RegisterRequest]) (*connect.Response[v1.RegisterResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("skillsphere.handler.v1.AuthService.Register is not implemented"))
}

func (UnimplementedAuthServiceHandler) Login(context.Context, *connect.Request[v1.LoginRequest]) (*connect.Response[v1.LoginResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("skillsphere.handler.v1.AuthService.Login is not implemented"))
}

func (UnimplementedAuthServiceHandler) Logout(context.Context, *connect.Request[v1.LogoutRequest]) (*connect.Response[v1.LogoutResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("skillsphere.handler.v1.AuthService.Logout is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) RefreshToken(context.Context, *connect.Request[v1.RefreshTokenRequest]) (*connect.Response[v1.RefreshTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("skillsphere.handler.v1.AuthService.RefreshToken is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) ValidateToken(context.Context, *connect.Request[v1.ValidateTokenRequest]) (*connect.Response[v1.ValidateTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("skillsphere.handler.v1.AuthService.ValidateToken is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) OAuthLogin(context.Context, *connect.Request[v1.OAuthLoginRequest]) (*connect.Response[v1.OAuthLoginResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("skillsphere.handler.v1.AuthService.OAuthLogin is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) RequestPasswordReset(context.Context, *connect.Request[v1.RequestPasswordResetRequest]) (*connect.Response[v1.RequestPasswordResetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("skillsphere.handler.v1.AuthService.RequestPasswordReset is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) ResetPassword(context.Context, *connect.Request[v1.ResetPasswordRequest]) (*connect.Response[v1.ResetPasswordResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("skillsphere.handler.v1.AuthService.ResetPassword is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) ChangePassword(context.Context, *connect.Request[v1.ChangePasswordRequest]) (*connect.Response[v1.ChangePasswordResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("skillsphere.handler.v1.AuthService.ChangePassword is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) VerifyEmail(context.Context, *connect.Request[v1.VerifyEmailRequest]) (*connect.Response[v1.VerifyEmailResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("skillsphere.handler.v1.AuthService.VerifyEmail is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) ResendVerificationEmail(context.Context, *connect.Request[v1.ResendVerificationEmailRequest]) (*connect.Response[v1.ResendVerificationEmailResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("skillsphere.handler.v1.AuthService.ResendVerificationEmail is not implemented"))
}
